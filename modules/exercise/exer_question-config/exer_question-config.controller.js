...
const question_config_service_1 = require("../../question-config/question-config.service");
...
__decorate([
    ...
    openapi.ApiResponse({ status: 200, type: [require("../../question-config/question-config.entity").QuestionConfig] }),
...
QuestionConfigController = __decorate([
    (0, swagger_1.ApiTags)('练习模块-试题设置'),
    (0, common_1.Controller)('question-configs'),
...
//# sourceMappingURL=exer_question-config.controller.js.map