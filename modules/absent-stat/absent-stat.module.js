...
exports.AbsentStatModule = void 0;
const common_1 = require("@nestjs/common");
const absent_stat_controller_1 = require("./absent-stat.controller");
...
let AbsentStatModule = class AbsentStatModule {
};
AbsentStatModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([absent_stat_entity_1.AbsentStat]),
        ...
        controllers: [absent_stat_controller_1.AbsentStatController],
        providers: [
            absent_stat_service_1.AbsentStatService,
...
exports.AbsentStatModule = AbsentStatModule;
//# sourceMappingURL=absent-stat.module.js.map