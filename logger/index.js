...
fs.ensureDirSync((0, path_1.join)(__dirname, LOG_DIR_NAME));
void ['request', 'response', 'error'].forEach((t) => {
    fs.ensureDirSync((0, path_1.join)(__dirname, LOG_DIR_NAME, t));
});
const resolvePath = (dir, filename) => (0, path_1.join)(__dirname, LOG_DIR_NAME, dir, filename);
const commonCinfig = {
    type: 'dateFile',
